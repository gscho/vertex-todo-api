package io.vertx.todolist.entity;
...
public class Todo {
	  ...
	  public Todo(String jsonStr) throws IOException {
	    this();
		ObjectMapper m = new ObjectMapper();
		Todo clone = null;
		try {
			clone = m.readValue(jsonStr, Todo.class);
		} catch (Exception any) {
			throw new IOException(any.getMessage());
		}
		this.merge(clone);
	  }
	  ...
	  public String toJson() throws IOException  {
		...
		String jsonStr = null;
		try {
			jsonStr = m.writeValueAsString(this);
		} catch (Exception any) {
			throw new IOException(any.getMessage());
		}
	    return jsonStr;
